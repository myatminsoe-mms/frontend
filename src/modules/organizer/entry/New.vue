    ...
    <form class="p-fluid" @submit.prevent="handleSubmit(!v$.$invalid)">
      <div class="grid">
        ...
        <div class="field col-12 md:col-6 lg:col-6">
          ...
          <!-- Server Validation -->
          <small v-if="errors.has('name')" class="p-error mt-2">
            <div class="mt-2" v-for="error in errors.get('name')" :key="error">
              {{ error }}
            </div>
          </small>
          <!-- Server Validation -->
        ...
        <!-- Email -->
        <div class="field col-12 md:col-6 lg:col-6">
          <label for="email" :class="{ 'p-error': v$.email.$invalid && submitted }">{{ $t('Email') }}<span class="p-error">*</span></label>
          ...
          <small v-if="(v$.email.$invalid && submitted) || v$.email.$pending.$response" class="p-error">{{ v$.email.required.$message.replace('Value', 'Email') }}</small><br/>
          ...
          <small v-if="errors.has('email')" class="p-error">
            <div class="mt-2" v-for="error in errors.get('email')" :key="error">
              {{ error }}
            </div>
          </small>
          <!-- Server Validation -->
        ...
        <div class="field col-12 md:col-6 lg:col-6">
          ...
          <small v-if="(v$.company_phone.$invalid && submitted) || v$.company_phone.$pending.$response" class="p-error">{{ v$.company_phone.required.$message.replace('Value', 'Phone Number') }}</small><br/>
        ...
        <div class="field col-12 md:col-6 lg:col-6">
          ...
          <small v-if="(v$.tax_payer_no.$invalid && submitted) || v$.tax_payer_no.$pending.$response" class="p-error">{{ v$.tax_payer_no.required.$message.replace('Value', 'Tax Payer No') }}</small><br/>
        ...
        <div class="field col-12 md:col-6 lg:col-6">
          ...
          <!--<small v-if="(v$.website.$invalid && submitted) || v$.website.$pending.$response" class="p-error">{{ v$.website.required.$message.replace('Value', 'Website') }}</small><br/>-->
        ...
        <div class="field col-12 md:col-6 lg:col-6">
          ...
          <small v-if="(v$.description.$invalid && submitted) || v$.description.$pending.$response" class="p-error">{{ v$.description.required.$message.replace('Value', 'Description') }}</small><br/>
          <!-- Server Validation -->
...
const { isLoading, v$, onFileChange, onFileRemove, avatarPreview, handleSubmit, submitted, errors } = useNew()
</script>
