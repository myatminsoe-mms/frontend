    ...
    <div>
        <TabView ref="tabViewRef" :activeIndex="activeTabIndex" class="custom-tab-view"
            ...
            <div class="p-1">
                        ...
                        <form class="p-fluid" @submit.prevent="handleSubmit(!v$.$invalid)">
                            ...
                            <div class="grid mt-2">
                                <div class="field col-12 md:col-12 lg:col-12">
                                    ...
                                    <InputText v-model="v$.title.$model" id="title"
                                ...
                                <div class="field col-12 md:col-6 lg:col-6">
                                    ...
                                    <Dropdown v-model="v$.type_id.$model" :options="types" :filter="true" optionLabel="name"
                                        optionValue="id" placeholder="Select your event type" class="w-full"
                                        :showClear="true" :class="{ 'p-invalid': v$.type_id.$invalid && submitted }" />
                                    <small v-if="(v$.type_id.$invalid && submitted) || v$.type_id.$pending.$response"
                                        class="p-error">
                                ...
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="category"
                                        :class="{ 'p-error': v$.category_id.$invalid && submitted }">Category <span
                                            class="p-error">*</span></label>
                                    <Dropdown v-model="v$.category_id.$model" :options="categories" :filter="true"
                                        optionLabel="name" optionValue="id" placeholder="Select your event category"
                                        class="w-full" :showClear="true"
                                        :class="{ 'p-invalid': v$.category_id.$invalid && submitted }" />
                                    <small
                                        v-if="(v$.category_id.$invalid && submitted) || v$.category_id.$pending.$response"
                                        class="p-error">
                                ...
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="organizer"
                                        :class="{ 'p-error': v$.organizer_id.$invalid && submitted }">Organizers <span
                                            class="p-error">*</span></label>
                                    <Dropdown v-model="v$.organizer_id.$model" :options="organizers" :filter="true"
                                        optionLabel="name" optionValue="id" placeholder="Select your event organizer"
                                        class="w-full" :showClear="true"
                                        :class="{ 'p-invalid': v$.organizer_id.$invalid && submitted }" />
                                    <small
                                        v-if="(v$.organizer_id.$invalid && submitted) || v$.organizer_id.$pending.$response"
                                        class="p-error">
                                ...
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="tags" :class="{ 'p-error': v$.tags.$invalid && submitted }">Tags <span
                                            class="p-error">*</span></label>
                                    <MultiSelect v-model="v$.tags.$model" display="chip" filter :options="tags"
                                        optionLabel="name" optionValue="name" placeholder="Select Tags"
                                        :maxSelectedLabels="5" class="w-full"
                                        :class="{ 'p-invalid': v$.tags.$invalid && submitted }" />
                                    <small v-if="(v$.tags.$invalid && submitted) || v$.tags.$pending.$response"
                                        class="p-error">
                                        {{ v$.tags.required.$message.replace('Value', 'Event tag') }}
                                    </small>
                                </div>
                                <div class="field col-12 md:col-12 lg:col-12">
                                    <label for="about" :class="{ 'p-error': v$.about.$invalid && submitted }">About the
                                        event <span class="p-error">*</span></label>
                                    <Textarea id="about" v-model="v$.about.$model" rows="4"
                                        placeholder="Tell us about our event"
                                        :class="{ 'p-invalid': v$.about.$invalid && submitted }"></Textarea>
                                    <small v-if="(v$.about.$invalid && submitted) || v$.about.$pending.$response"
                                        class="p-error">
                            ...
                            <div class="card-container mt-3">
                                <Card v-for="(template, index) in templates" :key="index"
                                    :class="{ 'selected-card': selectedTemplateIndex === index }"
                            ...
                            <div class="grid mt-2">
                                ...
                                <div class="field col-12 md:col-12 lg:col-12" v-if="isLocationSelected == 'VENUE'">
                                    <label for="venueAddress"
                                        :class="{ 'p-error': v$.venue_address.$invalid && submitted }">Address<span
                                            class="p-error">*</span></label>
                                    <InputText v-model="v$.venue_address.$model" id="venueAddress"
                                        placeholder="Enter your venue address"
                                        :class="{ 'p-invalid': v$.venue_address.$invalid && submitted }" />
                                    <small
                                        v-if="(v$.venue_address.$invalid && submitted) || v$.venue_address.$pending.$response"
                                        class="p-error">
                                ...
                                <div class="field col-12 md:col-12 lg:col-12" v-if="isLocationSelected == 'ONLINE'">
                                    <label for="onlineAddress"
                                        :class="{ 'p-error': v$.online_address.$invalid && submitted }">Address<span
                                            class="p-error">*</span></label>
                                    <InputText v-model="v$.online_address.$model" id="onlineAddress"
                                        placeholder="Enter your online address"
                                        :class="{ 'p-invalid': v$.online_address.$invalid && submitted }" />
                                    <small
                                        v-if="(v$.online_address.$invalid && submitted) || v$.online_address.$pending.$response"
                                        class="p-error">
                                        {{ v$.online_address.required.$message.replace('Value', 'Online Address') }}
                                    </small>
                                </div>
                                <div class="field col-12 md:col-12 lg:col-12" v-if="isLocationSelected == 'VENUE'">
                                    <label for="mapURL" :class="{ 'p-error': v$.map_url.$invalid && submitted }">Map
                                        URL<span class="p-error">*</span></label>
                                    ...
                                    <small
                                        v-if="(v$.map_url.$invalid && submitted && !v$.map_url.$dirty) || v$.map_url.$pending.$response"
                                        class="p-error">
                            ...
                            <div class="grid mt-2">
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="startDate" :class="{ 'p-error': v$.start_date.$invalid && submitted }">Start
                                        Date<span class="p-error">*</span></label>
                                    ...
                                    <small v-if="(v$.start_date.$invalid && submitted) || v$.start_date.$pending.$response"
                                        class="p-error">
                                        {{ v$.start_date.required.$message.replace('Value', 'Start Date') }}
                                    </small>
                                </div>
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="endDate" :class="{ 'p-error': v$.end_date.$invalid && submitted }">End
                                        Date<span class="p-error">*</span></label>
                                    <Calendar id="endDate" v-model="v$.end_date.$model" placeholder="Select End Date"
                                        :class="{ 'p-invalid': v$.end_date.$invalid && submitted }" />
                                    <small v-if="(v$.end_date.$invalid && submitted) || v$.end_date.$pending.$response"
                                        class="p-error">
                                        {{ v$.end_date.required.$message.replace('Value', 'End Date') }}
                                    </small>
                                </div>
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="startTime" :class="{ 'p-error': v$.start_time.$invalid && submitted }">Start
                                        Time<span class="p-error">*</span></label>
                                    <Calendar id="startTime" v-model="v$.start_time.$model" placeholder="Select Start Time"
                                        :class="{ 'p-invalid': v$.start_time.$invalid && submitted }" :timeOnly="true"
                                        :showSeconds="true" />
                                    <small v-if="(v$.start_time.$invalid && submitted) || v$.start_time.$pending.$response"
                                        class="p-error">
                                        {{ v$.start_time.required.$message.replace('Value', 'Start Time') }}
                                    </small>
                                </div>
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="endTime" :class="{ 'p-error': v$.end_time.$invalid && submitted }">End
                                        Time<span class="p-error">*</span></label>
                                    <Calendar id="endTime" v-model="v$.end_time.$model" placeholder="Select End Time"
                                        :class="{ 'p-invalid': v$.end_time.$invalid && submitted }" :timeOnly="true"
                                        :showSeconds="true" />
                                    <small v-if="(v$.end_time.$invalid && submitted) || v$.end_time.$pending.$response"
                                        class="p-error">
                            ...
                            <div class="flex justify-content-end mt-3">
                                <router-link :to="{ name: 'eventList' }">
                                    <div>
                                        <Button label="Cancel" class="mt-2 p-button-outlined p-button-secondary" />
                                    </div>
                                </router-link>
                                <div>
                                    <Button type="submit" label="save" severity="primary"
                                        class="ml-2 mt-2 p-button-primary" />
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <!-- Event Page  -->
                <TabPanel :header="panels[1].header">
                    <div>
                        <form @submit.prevent="handleSubmit(!v$.$invalid)">
                            ...
                            <div class="image-upload" v-if="!state.banner_images || state.banner_images.length == 0">
                                <div class="drag-area field col-12 md:col-12 lg:col-12" @dragover.prevent @dragenter.prevent
                                    ...
                                    <input type="file" id="file-input" style="display: none" @change="manualUploadBanner"
                                        multiple />
                            ...
                            <div class="preview" v-if="state.banner_images && state.banner_images.length > 0">
                                <!-- Show selected image -->
                                <div class="selected-image col-12 md:col-12 lg:col-12 p-0" v-if="selectedImageBanner">
                                    <img :src="`https://eventnex-dev.s3.ap-southeast-1.amazonaws.com/images/${selectedImageBanner}`"
                                        alt="Selected Image" />
                                </div>
                                <div class="image-item" v-for="image in state.banner_images" :key="image">
                                    <div class="delete-icon" @click="deleteImageBanner(image)">
                                        <i class="pi pi-times-circle"></i>
                                    </div>
                                    <img :src="`https://eventnex-dev.s3.ap-southeast-1.amazonaws.com/images/${image}`"
                                        alt="Uploaded Image" @click="selectImageBanner(image)" />
                                </div>
                                <div v-if="state.banner_images && state.banner_images.length < 5"
                                    class="file-upload-container">
                                    <input type="file" id="banner-img" style="display: none" @change="manualUploadBanner"
                                        multiple />
                                    <label for="banner-img" icon="" class="upload-button"> <i class="pi pi-plus-circle"></i>
                                        Add
                                        More </label>
                                </div>
                            </div>
                            ...
                            <div class="grid mt-2">
                                <div class="field col-12 md:col-6 lg:col-6">
                                    ...
                                    <InputNumber v-model="state.contact_information[0].phone_number" inputId="phone"
                                        :useGrouping="false" placeholder="Enter Phone Number" class="w-full" />
                                </div>

                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="email">Email Address <span class="p-error">*</span></label>
                                    <InputText v-model="state.contact_information[0].email" id="email"
                                        placeholder="Enter Your Email Address" class="w-full" type="email" />
                                </div>
                            </div>
                            ...
                            <div class="grid mt-2">
                                <div class="field col-12 md:col-6 lg:col-6">
                                    ...
                                    <InputText v-model="state.social_links.facebook_url" id="facebook"
                                        placeholder="Paste your Facebook link" class="w-full" />
                                </div>
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="instagram">Instagram (Optional)</label>
                                    <InputText v-model="state.social_links.instagram_url" id="instagram"
                                        placeholder="Paste your Instagram link" class="w-full" />
                                </div>
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="twitter">Twitter (Optional)</label>
                                    <InputText v-model="state.social_links.twitter_url" id="twitter"
                                        placeholder="Paste your Twitter link" class="w-full" />
                                </div>
                                <div class="field col-12 md:col-6 lg:col-6">
                                    <label for="linkedIn">LinkedIn (Optional)</label>
                                    <InputText v-model="state.social_links.linkedin_url" id="linkedIn"
                                        placeholder="Paste your LinkedIn link" class="w-full" />
                                </div>
                            </div>
                            ...
                            <div class="card mt-5">
                                <div class="flex justify-content-between">
                                    ...
                                    <Button class="add-btn p-button-secondary" label="Add"
                                        v-if="!state.sponsors || state.sponsors.length === 0"
                                        @click="addSponsorLevel(index)" />
                                    <span v-else class="remove-section cursor-pointer"
                                        @click="deleteAllSponsorLevels">Remove
                                        Section</span>
                                </div>

                                <div v-for="(sponsorLevel, index) in state.sponsors" :key="index"
                                    class="col-12 pl-2 pr-0 card">
                                    <!-- Sponsor Level Form -->
                                    <div class="sponsor-level">
                                        <h5>Sponsor Level {{ index + 1 }}</h5>
                                        <div class="sponsor-delete-icon cursor-pointer" @click="deleteSponsorLevel(index)">
                                            <i class="pi pi-times-circle"></i>
                                        </div>
                                        <div class="">
                                            <label for="sponsorLevelTitle" class="label">Sponsor Level Name</label>
                                            <div class="mt-2">
                                                <InputText v-model="sponsorLevel.tier" id="sponsorLevelTitle"
                                                    class="w-full" />
                                            </div>
                                        </div>
                                        <!-- Sponsor Logo Images -->
                                        <div class="preview">
                                            <div class="image-item" v-for="image in sponsorLevel.images" :key="image.id">
                                            ...
                                            <div class="file-upload-container">
                                                ...
                                                <label :for="'logo-img-' + index" icon="" class="upload-button"> <i
                                ...
                                <Button
                                    ...
                                    @click="addSponsorLevel(index)" v-if="state.sponsors && state.sponsors.length > 0">
                            ...
                            <div class="card mt-5">
                                <div class="flex justify-content-between">
                                    ...
                                    <Button class="add-btn p-button-secondary" label="Add" v-if="!state.agenda"
                                        @click="addAgendaTabview()" />
                                    <span v-else class="remove-section" @click="deleteAllAgenda">Remove Section</span>
                                </div>
                                <TabView :activeIndex="activeAgendaTabIndex" @onChange="handleAgendaTabChange"
                                    class="agenda-tab-view" v-if="state.agenda && state.agenda.length > 0">
                                    <TabPanel v-for="(agenda, tabIndex) in state.agenda" :key="tabIndex">
                                        <template #header>
                                            <span v-if="!isEditing[tabIndex]" @click="startEditing(tabIndex)">
                                                {{ !editedAgenda[tabIndex] ? `Day ${tabIndex + 1} Agenda` :
                                                    editedAgenda[tabIndex] }}
                                            </span>
                                        ...
                                        <div v-for="(slot, agendaFormIndex) in agenda.slots" :key="agendaFormIndex"
                                            class="card agenda-form">
                                            <h5>Agenda Form {{ agendaFormIndex + 1 }}</h5>
                                            <div class="delete-faq-icon cursor-pointer mt-3"
                                                @click="deleteAgendaForm(tabIndex, agendaFormIndex)">
                                                <i class="pi pi-times-circle"></i>
                                            </div>
                                            <!-- Title -->
                                            <div class="field">
                                                <label for="agendaTitle" class="label">Title<span
                                                        class="p-error">*</span></label>
                                                <div class="mt-2">
                                                    <InputText v-model="slot.title" :id="'agendaTitle_' + agendaFormIndex"
                                                        class="w-full" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="time-fields mr-4">
                                                <div class="field col-12 md:col-6 lg:col-6 px-0">
                                                    ...
                                                    <div class="mt-2">
                                                        <Calendar v-model="slot.start_at"
                                                            :id="'agendaStartTime_' + agendaFormIndex" class="w-full"
                                                            timeOnly />
                                                    </div>
                                                </div>
                                                <div class="field col-12 md:col-6 lg:col-6 px-0">
                                                    ...
                                                    <div class="mt-2">
                                                        <Calendar v-model="slot.end_at"
                                                            :id="'agendaEndTime_' + agendaFormIndex" class="w-full"
                                                            timeOnly />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="field mb-4" v-if="showDescription">
                                                ...
                                                <div class="mt-2">
                                                    <Textarea v-model="slot.description"
                                                        :id="'agendaDescription_' + agendaFormIndex" class="w-full" />
                                                </div>
                                            </div>

                                            <!-- Performer or speaker -->
                                            <div class="grid">
                                                <div v-for="(performer, performerIndex) in slot.performers"
                                                    :key="performerIndex" class="performer-container col-6">
                                                    <div class="avatar-uploader">
                                                        <div class="avatar" @click="openFileInput(performerIndex)">
                                                            <img v-if="performer.image"
                                                                :src="`https://eventnex-dev.s3.ap-southeast-1.amazonaws.com/images/${performer.image}`"
                                                                alt="Avatar" />
                                                            <span v-else><svg xmlns="http://www.w3.org/2000/svg" width="22"
                                                        ...
                                                        <input type="file"
                                                            @change="handleFileChange(tabIndex, agendaFormIndex, performerIndex, $event)"
                                                            class="avatar-file" :id="'avatarInput_' + performerIndex" />
                                                    </div>
                                                    <div class="w-full">
                                                        <InputText v-model="performer.name"
                                                            :id="'performerName_' + performerIndex" class="w-full"
                                                            placeholder="Enter Performer or Speaker Name" />
                                                    </div>
                                                    <span class="performer-delete-icon cursor-pointer"
                                                        @click="deletePerformer(tabIndex, agendaFormIndex, performerIndex)">
                                                        <i class="pi pi-times-circle"></i>
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="my-5">
                                                <span @click="addPerformer(tabIndex, agendaFormIndex)"
                                                    v-if="slot.performers && slot.performers.length < 4"
                                                    class="mr-3 cursor-pointer"><i class="pi pi-user mr-2"></i> Speaker or
                                                    Performer</span>
                                                <span @click="showDescriptionForm" v-if="!showDescription"
                                                    class="description  cursor-pointer"><i
                                                        class="pi pi-align-right mr-2"></i> Description</span>
                                            </div>
                                        </div>
                                        <Button
                                            class="add-btn align-items-center justify-content-center p-button p-button-secondary p-component text-center w-full mt-4"
                                            @click="addAgendaForm(tabIndex)" v-if="agendaForms.length > 0">
                                            <i class="pi pi-plus-circle"></i>
                                    ...
                                    <TabPanel class="fixed-tab-panel">
                                        <template #header>
                                            ...
                                            <span class="" @click="addAgendaTabview()">Add New Day Agenda</span>
                                        </template>
                                    </TabPanel>
                                </TabView>
                            </div>
                            ...
                            <div class="card mt-5">
                                <div class="flex justify-content-between">
                                    ...
                                    <Button class="add-btn p-button-secondary" label="Add"
                                        v-if="!state.faqs || state.faqs.length == 0" @click="addFAQ" />
                                    <span v-else class="remove-section cursor-pointer" @click="deleteAllFAQ">Remove
                                        Section</span>
                                </div>

                                <!-- FAQ Form Section -->
                                <div v-for="(faq, index) in state.faqs" :key="index" class="col-12 pl-2 pr-0 my-4 card">
                                    <!-- FAQ Form -->
                                    <div class="faq-form">
                                        <h5>FAQ {{ index + 1 }}</h5>
                                        <div class="delete-faq-icon cursor-pointer" @click="deleteFAQ(index)">
                                            <i class="pi pi-times-circle"></i>
                                        </div>
                                ...
                                <Button
                                    ...
                                    @click="addFAQ" v-if="state.faqs && state.faqs.length > 0">
                                    <i class="pi pi-plus-circle"></i>
                            ...
                            <div class="grid">
                                <div class="field col-12 md:col-12 lg:col-12">
                                    <label for="additionalInfo">Add more information to your event page (Terms and
                                        Conditions,
                                        Refund Policy,
                                        etc...)</label>
                                    <Editor v-model="state.additional_information" id="additionalInfo"
                            ...
                            <div class="image-upload" v-if="!state.event_images || state.event_images.length == 0">
                                ...
                                <div class="drag-area field col-12 md:col-12 lg:col-12" @dragover.prevent @dragenter.prevent
                                    ...
                                    <input type="file" id="event-img" style="display: none" @change="manualUploadEvent"
                                        multiple />
                                    <label for="event-img" class="upload-device">Upload from your device</label>
                                </div>
                            </div>
                            <!-- Display uploaded images as thumbnails -->
                            <div class="preview" v-if="state.event_images && state.event_images.length > 0">
                                <!-- Show selected image -->
                                <div class="selected-image col-12 md:col-12 lg:col-12 p-0" v-if="selectedImageEvent">
                                    <img :src="`https://eventnex-dev.s3.ap-southeast-1.amazonaws.com/images/${selectedImageEvent}`"
                                        alt="Selected Image" />
                                </div>
                                <div class="image-item" v-for="image in state.event_images" :key="image">
                                    <div class="delete-icon" @click="deleteImageEvent(image)">
                                        <i class="pi pi-times-circle"></i>
                                    </div>
                                    <img :src="`https://eventnex-dev.s3.ap-southeast-1.amazonaws.com/images/${image}`"
                                        alt="Uploaded Image" @click="selectImageEvent(image)" />
                                </div>
                                <div v-if="state.event_images && state.event_images.length < 5"
                                    class="file-upload-container">
                                    <input type="file" id="file-input" style="display: none" @change="manualUploadEvent"
                                        multiple />
                                    <label for="file-input" class="upload-button"> <i class="pi pi-plus-circle"></i> Add
                                        More
                                    </label>
                                </div>
                            </div>
                ...
                <!-- Tickets  -->
                <TabPanel :header="panels[2].header">
                    <form @submit.prevent="handleSubmit(!v$.$invalid)">
                        <div v-if="!showTicketForm && showTicketList">
                            <div class="card">
                                <div class="flex justify-content-between">
                                    <h1 class="ticket-title">Tickets</h1>
                                    <Button label="Create New Ticket" icon="pi pi-plus" severity="primary"
                                        @click="showNewTicketForm" />
                                </div>
                                <div v-if="!state.event_tickets || state.event_tickets.length === 0" class="no-tickets">
                                ...
                                <div v-else>
                                    <DataTable :value="filteredTickets" :columns="columns" :frozenValue="frozenColumns"
                                        :scrollable="true">
                                        <Column v-for="column in columns" :key="column.field" :field="column.field"
                                            :header="column.header" :sortable="column.sortable" :style="column.style"
                                            :frozen="column.frozen" :alignFrozen="column.alignFrozen">
                                            <template v-if="column.field === 'actions'" #body="{ data }">
                                                <div class="flex">
                                                    <Button type="button" icon="pi pi-pencil" class="mr-2" text rounded
                                                        @click="startEditMode(data.id)" :disabled="data.id == null" />
                                                    <Button type="button" icon="pi pi-trash" class="p-button-danger" text
                                                        rounded @click="deleteTicket(data.id)" />
                                                </div>
                                            </template>
                                        </Column>
                                    </DataTable>
                        ...
                        <div v-if="showTicketForm && !showTicketList">
                            <ticketForm @submit-form="handleChildFormSubmission" @cancel-form="ticketCancel"
                                :newTicketData="newTicketData" :showTicketFormProp="showTicketForm"
                                :showTicketListProp="showTicketList" :isEditMode="isEditMode" :eventId="eventId" />
                            <!-- <TicketForm :newTicketData="yourNewTicketData" :showTicketFormProp="trueOrFalseValue" :showTicketListProp="trueOrFalseValue" :isEditMode="false" /> -->
                        </div>
                    </form>
                </TabPanel>
                    ...
                    <form @submit.prevent="handleSubmit(!v$.$invalid)">
                        <div class="event-url-form">
                            ...
                            <!-- <div class="event-visibility mb-5">
                                ...
                                <p class="ml-5">Will not appear on EventNex and only available through a link and search
                                    engines
                                </p>
                            </div> -->
                            <div class="event-visibility mb-5">
                                <h5 class="publish-title">Who can see your event?</h5>
                                <div v-for="visibility in visibilities" :key="visibility.code" class="mb-2">
                                    <div class="flex">
                                        <RadioButton v-model="state.visibility" :inputId="visibility.code" name="visibility"
                                            :value="visibility.name" />
                                        <label :for="visibility.code" class="mx-2">{{ visibility.name }}</label>
                                    </div>
                                    <p class="ml-5">{{ visibility.label }}</p>
                                </div>
                            </div>
                            ...
                            <div v-if="publishOption === 'schedule'" class="grid">
                                <div class="field mb-3 col-6 md:col-3 lg:col-3">
                                    ...
                                    <Calendar v-model="publishStartDate" id="publishStartDate" placeholder="Choose date"
                                        class="w-full" />
                                </div>
                                <div class="field mb-3 col-6 md:col-3 lg:col-3">
                                    <label for="startTime" class="block">Start Time</label>
                                    <Calendar v-model="publishStartTime" id="publishStartTime" placeholder="Choose time"
                                        timeOnly class="w-full" :showSeconds="true" />
                                </div>
                            </div>

                            <div class="flex justify-content-end mt-3">
                                <div>
                                    <Button @click="draftSave(!v$.$invalid)" label="Draft Save"
                                        class="ml-2 mt-2 p-button-secondary" />
                                </div>
                                <div>
                                    <Button type="submit" label="save" severity="primary"
                                        class="ml-2 mt-2 p-button-primary" />
